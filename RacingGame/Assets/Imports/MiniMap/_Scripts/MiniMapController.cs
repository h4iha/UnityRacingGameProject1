...
public class MiniMapController : MonoBehaviour {
	...
	void SetCam(){
		...
		if (rotateWithTarget)
		{
			mapCamera.transform.eulerAngles = Player.GetComponent<Transform>().eulerAngles + rotationOfCam;
		}
		mapCamera.transform.position = Player.GetComponent<Transform>().position + cameraOffset;
	}
