...
public class MapObject : MonoBehaviour {
	...
	public void SetMiniMapEntityValues(MiniMapController controller,MiniMapEntity mme, GameObject attachedGO, Camera renderCamera, GameObject parentPanelGO){
		...
		miniMapTarget = Player.GetComponent<Transform>();
		SetPositionAndRotation ();
	...
	void SetPosition(){
		...
		if (linkedMiniMapEntity.clampInBorder && Mathf.Abs(Vector3.Distance(owner.transform.position, Player.GetComponent<Transform>().position)) < linkedMiniMapEntity.clampDist) {
